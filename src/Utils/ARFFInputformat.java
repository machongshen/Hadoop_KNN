...
public class ARFFInputformat extends FileInputFormat<Text, SparseVector> {
    ...
    static class Reader extends RecordReader<Text, SparseVector> {
        ...
        public boolean nextKeyValue() throws IOException, InterruptedException {
            if (r.nextKeyValue()) {
                ...
                String str = "1";
                Vector2<String, SparseVector,String> v = readLineTrain(start, line.toString(), str);
    ...
    public static Vector2<String, SparseVector,String> readLineTrain(long start, String line, String str) {
    ...
    public static Vector2<String, SparseVector,String> readLine(long start, String line, String str) {
        if (line.startsWith("{")) {
